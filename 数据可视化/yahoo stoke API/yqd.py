...
def load_yahoo_quote(ticker, begindate, enddate, info = 'quote'):
	...
	return alines.split('\n')
'''
查询URL:https://query1.finance.yahoo.com/v7/finance/download/TTTT?period1=pppppppp&period2=qqqqqqqq&interval=1d&events=eeeeeeee&crumb=cccccccc
TTTT - 代码（例如，AAPL，MSFT等）
pppppppp - Period1是开始日期的时间戳（POSIX时间戳）
qqqqqqqq - Period2是结束日期的时间戳（POSIX时间戳）
eeeeeeee - 事件，可以是'历史'，'div'或'split'之一
cccccccc - Crumb
字段：
