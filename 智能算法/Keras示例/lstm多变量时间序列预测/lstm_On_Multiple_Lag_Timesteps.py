...
def split(reframed,n_features=1,n_hours=1):
...
def predict(model,test_X,test_y,scaler,n_hours,n_features):
    # make a prediction
...
if __name__=='__main__':
    ...
    n_hours = 3
    n_features = 8
    reframed,scaler=prepare(n_hours)
    train_X, train_y, test_X, test_y=split(reframed,n_features,n_hours)
    model,history=LSTM_process(train_X, train_y, test_X, test_y)
    predict(model,test_X, test_y,scaler,n_hours,n_features)
